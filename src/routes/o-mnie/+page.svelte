...
<svelte:head>
	<title>{$tSafe('meta.about.title')}</title>
	<meta name="description" content={$tSafe('meta.about.description')} />
</svelte:head>
	...
	<div class="section relative z-10">
		<div class="max-w-4xl">
			<div class="mb-8 observe">
				<p class="font-bold tracking-[0.3em] uppercase text-sm mb-6 animate-pulse-slow neon-text" style="color: {colorPalette.accent}">{$tSafe('about.hero.label')}</p>
				<h1 class="text-4xl md:text-6xl lg:text-7xl font-black mb-6 leading-tight" style="font-family: 'Playfair Display', serif;">
					{$tSafe('about.hero.name')}<br>
					<span style="color: #FF6B9D;">{$tSafe('about.hero.surname')}</span>
				</h1>
				<p class="text-xl md:text-2xl font-bold mb-4 text-white/90 leading-tight">
					{$tSafe('about.hero.title')}
				</p>
				<p class="text-lg md:text-xl mb-8 max-w-2xl leading-relaxed text-gray-100">
					{$tSafe('about.hero.description')}
				</p>
			</div>
		</div>
	</div>
	...
	<div class="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
		<div class="observe">
			<div class="aspect-[3/4] bg-blue-100 relative overflow-hidden rounded-2xl shadow-2xl group">
				<img
					src={magdaPhoto}
					alt="{$tSafe('about.hero.name')} {$tSafe('about.hero.surname')} - {$tSafe('about.hero.title')}"
		...
		<div class="space-y-8 observe">
			<div>
				<h2 class="text-3xl md:text-4xl lg:text-5xl font-black mb-6 leading-tight" style="font-family: 'Playfair Display', serif;">
					{$tSafe('about.experience.heading')}<br>
					<span style="color: #00D4FF;">{$tSafe('about.experience.headingAccent')}</span>
				</h2>
				<div class="space-y-6 text-gray-600 leading-relaxed text-lg">
					<p>
						{$tSafe('about.experience.paragraph1')}
					</p>
					<p>
						{$tSafe('about.experience.paragraph2')}
					</p>
					<p>
						<strong style="color: {colorPalette.primary}">{$tSafe('about.experience.paragraph3')}</strong> {$tSafe('about.experience.skills')}
					</p>
				</div>
			</div>
		</div>
...
<section class="section bg-blue-50 border-t-4" style="border-top-color: {colorPalette.accent};">
	<div class="text-center mb-16 observe">
		<p class="font-black tracking-[0.3em] uppercase text-sm mb-4" style="color: {colorPalette.primary}">{$tSafe('about.skills.label')}</p>
		<h2 class="text-3xl md:text-4xl lg:text-5xl font-black mb-6 leading-tight" style="font-family: 'Playfair Display', serif;">
			{$tSafe('about.skills.heading')}<br>
			<span style="color: {colorPalette.primary}">{$tSafe('about.skills.headingAccent')}</span>
		</h2>
	</div>
	...
	<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
		<div class="bg-white p-8 rounded-2xl border-2 border-blue-100 hover:border-blue-300 transition-all duration-300 observe group">
			<h3 class="text-xl font-black mb-3" style="font-family: 'Playfair Display', serif; color: {colorPalette.primary}">{$tSafe('about.skills.architecture.title')}</h3>
			<p class="text-gray-600 leading-relaxed">
				{$tSafe('about.skills.architecture.description')}
			</p>
			<ul class="mt-4 space-y-2 text-sm text-gray-600">
				<li>• {$tSafe('about.skills.architecture.skill1')}</li>
				<li>• {$tSafe('about.skills.architecture.skill2')}</li>
				<li>• {$tSafe('about.skills.architecture.skill3')}</li>
			</ul>
		</div>

		<div class="bg-white p-8 rounded-2xl border-2 border-blue-100 hover:border-blue-300 transition-all duration-300 observe group">
			<h3 class="text-xl font-black mb-3" style="font-family: 'Playfair Display', serif; color: {colorPalette.primary}">{$tSafe('about.skills.graphics.title')}</h3>
			<p class="text-gray-600 leading-relaxed">
				{$tSafe('about.skills.graphics.description')}
			</p>
			<ul class="mt-4 space-y-2 text-sm text-gray-600">
				<li>• {$tSafe('about.skills.graphics.skill1')}</li>
				<li>• {$tSafe('about.skills.graphics.skill2')}</li>
				<li>• {$tSafe('about.skills.graphics.skill3')}</li>
			</ul>
		</div>

		<div class="bg-white p-8 rounded-2xl border-2 border-blue-100 hover:border-blue-300 transition-all duration-300 observe group">
			<h3 class="text-xl font-black mb-3" style="font-family: 'Playfair Display', serif; color: {colorPalette.primary}">{$tSafe('about.skills.ai.title')}</h3>
			<p class="text-gray-600 leading-relaxed">
				{$tSafe('about.skills.ai.description')}
			</p>
			<ul class="mt-4 space-y-2 text-sm text-gray-600">
				<li>• {$tSafe('about.skills.ai.skill1')}</li>
				<li>• {$tSafe('about.skills.ai.skill2')}</li>
				<li>• {$tSafe('about.skills.ai.skill3')}</li>
			</ul>
		</div>
	</div>
</section>
...
<section class="section gradient-bg text-white relative overflow-hidden border-t-4" style="border-top-color: {colorPalette.accent};">
	...
	<div class="max-w-4xl mx-auto text-center observe relative z-10">
		<h2 class="text-3xl md:text-4xl lg:text-5xl font-black mb-8 leading-tight" style="font-family: 'Playfair Display', serif;">
			<span style="color: #FF6B9D;">{$tSafe('about.philosophy.heading')}</span> {$tSafe('about.philosophy.headingAccent')}
		</h2>

		<div class="grid md:grid-cols-2 gap-8 mb-12">
			<div class="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20">
				<h3 class="text-xl font-black mb-3" style="font-family: 'Playfair Display', serif;">{$tSafe('about.philosophy.functionality.title')}</h3>
				<p class="text-gray-200 leading-relaxed">
					{$tSafe('about.philosophy.functionality.description')}
				</p>
			</div>

			<div class="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20">
				<h3 class="text-xl font-black mb-3" style="font-family: 'Playfair Display', serif;">{$tSafe('about.philosophy.personality.title')}</h3>
				<p class="text-gray-200 leading-relaxed">
					{$tSafe('about.philosophy.personality.description')}
				</p>
			</div>

			<div class="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20">
				<h3 class="text-xl font-black mb-3" style="font-family: 'Playfair Display', serif;">{$tSafe('about.philosophy.innovation.title')}</h3>
				<p class="text-gray-200 leading-relaxed">
					{$tSafe('about.philosophy.innovation.description')}
				</p>
			</div>

			<div class="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20">
				<h3 class="text-xl font-black mb-3" style="font-family: 'Playfair Display', serif;">{$tSafe('about.philosophy.partnership.title')}</h3>
				<p class="text-gray-200 leading-relaxed">
					{$tSafe('about.philosophy.partnership.description')}
				</p>
			</div>
		</div>
		...
		<div class="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20 max-w-2xl mx-auto">
			<blockquote class="text-xl md:text-2xl font-light italic mb-4" style="font-family: 'Playfair Display', serif;">
				"{$tSafe('about.philosophy.quote')}"
			</blockquote>
			<p class="font-bold" style="color: #00D4FF;">— {$tSafe('about.hero.name')} {$tSafe('about.hero.surname')}</p>
		</div>
	</div>
</section>
...
<section class="section bg-blue-50 border-t-4" style="border-top-color: {colorPalette.accent};">
	<div class="max-w-4xl mx-auto text-center observe">
		<h2 class="text-3xl md:text-4xl lg:text-5xl font-black mb-6 leading-tight" style="font-family: 'Playfair Display', serif;">
			{$tSafe('about.cta.heading')}<br>
			<span style="color: #FF6B9D;">{$tSafe('about.cta.headingAccent')}</span>
		</h2>
		<p class="text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
			{$tSafe('about.cta.description')}
		</p>
		<div class="flex flex-col sm:flex-row gap-4 justify-center">
			<a href="/#kontakt" class="btn">
				{$tSafe('about.cta.button1')}
			</a>
			<a href="/#portfolio" class="btn-secondary">
				{$tSafe('about.cta.button2')}
			</a>
		</div>
	</div>
</section>
