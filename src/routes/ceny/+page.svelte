	...
	<div class="section relative z-10">
		<div class="max-w-4xl">
			<div class="mb-8 observe">
				...
				>
					<EditableText key="pricing.page.label" tag="span" />
				</p>
				<h1
					class="text-4xl md:text-6xl lg:text-7xl font-black mb-6 leading-tight"
					style="font-family: 'Playfair Display', serif;"
				>
					<EditableText key="pricing.page.heading" tag="span" /><br />
					<span style="color: #1DA898;"
						><EditableText
							key="pricing.page.headingAccent"
							tag="span"
						/></span
					>
				</h1>
				...
				>
					<EditableText key="pricing.page.tagline" tag="span" />
				</p>
				<p
					class="text-lg md:text-xl mb-8 max-w-2xl leading-relaxed text-gray-100"
				>
					<EditableText key="pricing.page.description" tag="span" />
				</p>
			</div>
		</div>
	</div>
...
<section class="section bg-white relative overflow-hidden">
	...
	></div>
	<div
		class="absolute top-1/2 right-1/3 w-40 h-40 md:w-80 md:h-80 rounded-full filter blur-3xl opacity-15"
	...
	<div class="space-y-16 relative z-10 max-w-7xl mx-auto">
		{#each pricingTiers as journey, i}
			<div class="observe" style="animation-delay: {i * 200}ms">
				<div
					class="bg-white rounded-3xl shadow-sm border border-[#27275b]/10 overflow-hidden transition-all duration-500 hover:shadow-2xl {journey.highlight
						? 'ring-2 ring-offset-4'
						: ''}"
					style={journey.highlight
						? `ring-color: ${colorPalette.primary}; --tw-ring-offset-color: rgba(var(--color-primary-rgb, 59, 130, 246), 0.1);`
						: ""}
				>
					<!-- Journey Header -->
					<div class="relative">
						{#if journey.highlight}
							<div
								class="absolute top-0 left-0 right-0 h-2 rounded-full"
								style="background-color: {colorPalette.accent};"
							></div>
						{/if}
						...
						<div class="p-8 lg:p-12">
							...
							>
								<div class="flex-1">
									<h3
										class="text-3xl lg:text-4xl font-black mb-2"
										style="font-family: 'Playfair Display', serif; color: {journey.highlight
									...
									<p
										class="text-lg font-medium mb-3 text-[#27275b]/80"
									>
										<EditableText
											key={journey.subtitleKey}
											tag="span"
										/>
									</p>
									<p
										class="text-[#27275b]/90 leading-relaxed max-w-2xl"
									>
										<EditableText
											key={journey.descriptionKey}
											tag="span"
										/>
									</p>
								</div>
								...
								<div class="lg:text-right">
									<div
										class="inline-block p-6 rounded-2xl border-2"
										style="background-color: #D9F0ED; border-color: {colorPalette.primary}; isolation: isolate;"
									>
										<div
											class="text-sm uppercase tracking-wider mb-1 font-bold"
											style="color: {colorPalette.primary};"
										>
											<EditableText
												key="pricing.page.investmentLabel"
												tag="span"
											/>
										</div>
										<div
					...
					<div class="px-8 lg:px-12 pb-12">
						<div class="border-t border-[#27275b]/10 pt-8">
							<h4 class="text-lg font-bold mb-6 text-[#27275b]">
								<EditableText
									key="pricing.page.processLabel"
									tag="span"
								/>
							</h4>
							<div class="grid md:grid-cols-2 gap-6">
								{#each journey.processKeys as processKey, stepIndex}
									<div class="flex items-start gap-4">
										...
										<p
											class="text-[#27275b]/90 leading-relaxed"
										>
											<EditableText
												key={processKey}
												tag="span"
						...
						<!-- CTA -->
						<div
							class="mt-8 pt-8 border-t border-[#27275b]/10 text-center"
						>
							<p class="text-sm text-[#27275b]/70 mb-4">
								<EditableText
									key="pricing.page.ctaQuestion"
									tag="span"
								/>
							</p>
							<a
								href="/#kontakt"
								class="inline-flex items-center gap-3 px-8 py-4 rounded-xl border-2 text-white transition-all duration-300 font-bold text-sm group transform hover:scale-110"
	...
	<div class="mt-20 text-center observe max-w-4xl mx-auto">
		<div
			class="p-8 lg:p-12 rounded-3xl border-4"
			style="background-color: rgba(29, 168, 152, 0.05); border-color: {colorPalette.secondary};"
		>
			<h3
				class="text-3xl lg:text-4xl font-black mb-4"
				style="font-family: 'Playfair Display', serif; color: {colorPalette.primary}"
			>
				<EditableText
					key="pricing.page.everyProjectHeading"
					tag="span"
				/>
			</h3>
			<p class="text-lg text-[#27275b]/90 mb-8 leading-relaxed">
				<EditableText
					key="pricing.page.everyProjectDescription"
					tag="span"
				/>
			</p>
			<div
			...
			>
				...
				>
					<span
						><EditableText
							key="pricing.page.ctaConsultation"
							tag="span"
						/></span
					>
					<svg
				...
				<div class="text-sm text-[#27275b]/70">
					<EditableText
						key="pricing.page.consultationDetails"
						tag="span"
					/>
				</div>
			</div>
